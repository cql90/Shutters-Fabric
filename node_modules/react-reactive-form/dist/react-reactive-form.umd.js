(function (global, factory) {
  ...
  (factory((global.ReactiveForm = {}),global.React,global.PropTypes));
  ...
  var FormControlContext = React.createContext(null);
  ...
  var FieldGroup = function FieldGroup(props) {
    ...
    var context = React.useContext(FormControlContext);
    ...
    return React__default.createElement(FormControlContext.Provider, {
      value: control
    }, React__default.createElement(Field, FieldProps));
  };
  ...
  var FieldControl = function FieldControl(props) {
    ...
    var _useState = React.useState(configureControl(props, context, 'FormControl')),
    ...
    return React__default.createElement(Field, FieldProps);
  };
      ...
      value: function setControl(configProps, key) {
        ...
        if (name && name.startsWith(FIELD_CONFIG_STRING) || typeof configProps.index === 'string' && configProps.index.startsWith(FIELD_CONFIG_STRING)) {
          ...
          if (configProps.isStatic === false) {
            return React__default.createElement(Field, Object.assign({}, { control: this.form }, propsToBePassed));
          }
        ...
        if (configProps.controls) {
          if (configProps.controls instanceof Array) {
            ...
            return React__default.createElement(FieldArray, Object.assign({}, propsToBePassed, {
            ...
            return React__default.createElement(FieldGroup, Object.assign({}, propsToBePassed, {
              render: function render() {
          ...
          return React__default.createElement(FieldControl, propsToBePassed);
        }
      }
    }, {
      key: 'generateFields',
