    ...
    return (
      <div className="container-fluid">
        ...
        <div className="div-order-form" style={{height: 300, display: 'inline-block'}}>
            ...
            >
            <Form>
                <TextBoxComponent label="" name="saleName" type="text" style={{display: "none"}}placeholder="Came back Customer" />
                <br></br>
                <button type="submit" classN="btn btn-primary btn-lg" style={{marginTop: -5}}>Submit</button>
            </Form>      
            </Formik>
        </div>
      </div>
