...
const NewOrRetrieveCustomerForm = () => {  
    return (
      <div className="container-fluid">
        ...
        <div style={{width: 300, height: 300, display: 'inline-block', backgroundColor: 'red'}}></div>
        <div className="div-order-form" style={{width: 300, height: 300, display: 'inline-block', backgroundColor: 'red'}}>
            <div className=" " >
