...
const jobType = JSON.parse(JSON.stringify(state))
const selectState = JSON.parse(JSON.stringify(dataSelect))
    ...
    <div className="form-login-position">
      ...
      >
        <Form>
          ...
          <SelectComponent label="State" name="state" type="select" options={dataSelect} />
